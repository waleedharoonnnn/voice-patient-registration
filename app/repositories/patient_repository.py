...
Commit/rollback is handled centrally by the `get_db`/`get_webhook_db` dependencies (see
...
def _translate_integrity_error(exc: IntegrityError) -> ConflictError | ValidationFailedError:
