...
from app.models import Patient  # noqa: F401  (registers the table on Base.metadata)
...
# the local Docker Postgres) may pre-set sqlalchemy.url; only fall back to settings
# otherwise.
